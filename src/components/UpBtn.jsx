...
const UpBtn = () => {
  ...
  return (
    <button
      onClick={handleClick}
      className={`fixed bottom-6 right-6  rounded-xl  bg-gradient-to-r from-orange-500 to-orange-400 p-3 text-white shadow-lg transition-all duration-300 ${buttonVisibilityClass} ${scalingClass}`}
    >
