const Home = () => {
  return (
    <section
      id="Home"
      className={`h-[700px]  border-b-8 border-[orange] bg-[rgba(0,0,0,0.6)]  bg-[url("hero.jpg")] bg-cover bg-center  bg-no-repeat pt-3 bg-blend-darken md:h-[700px]`}
    >
      <div className=" flex flex-col items-center justify-center gap-2 pt-32 md:pt-40">
