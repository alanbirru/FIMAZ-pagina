const Home = () => {
  return (
    <section
      id="inicio"
      className={`h-[700px]  border-b-8 border-[orange] bg-[rgba(0,0,0,0.63)]  bg-[url("hero.jpg")] bg-cover bg-center  bg-no-repeat pt-3 bg-blend-darken md:h-[1500px]`}
    >
      <div className=" flex flex-col items-center justify-center gap-2  pt-[100px]  md:pt-[480px]">
        ...
        <button className=" text mt-9 w-[70%]  rounded-xl bg-[orange] p-5 text-white transition-all hover:scale-110 md:w-[250px]">
          Lorem Ipsum
        </button>
      </div>
    </section>
