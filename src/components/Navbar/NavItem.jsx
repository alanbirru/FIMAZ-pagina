    ...
    <div>
      <Link activeClass="active" smooth spy to={id}>
        <li
          ...
          className={`@apply  cursor-pointer border-b-[1px] border-gray-400  py-5 pl-6 text-lg transition-all delay-75 ease-in hover:text-primary md:my-0 md:ml-4 md:w-auto  md:px-4 md:py-7 md:text-gray-700    ${
            id === activeSelection
